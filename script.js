  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (value !== '') {
        ...
        if ((type === 'text' || field.tagName.toLowerCase() === 'textarea') && required) {
          if (value.length < 2) {
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      fetch(action, {
        ...
        .then(function (response) {
          if (response.ok) {
            contactForm.reset();
            currentFields.forEach(function (field) { clearError(field); });
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Israel Spirit uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'e24e428d-8539-48b8-9d80-34c4b0d19fd0',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'e24e428d-8539-48b8-9d80-34c4b0d19fd0';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'e24e428d-8539-48b8-9d80-34c4b0d19fd0';
